...
class KiTS21Dataset:
    ...
    def __getitem__(self, idx):
        ...
        scan_id = self.scan_list[idx]
        ct_path = os.path.join(self.data_dir, 'kits21', 'data', scan_id, 'imaging.nii.gz')
        seg_path = os.path.join(self.data_dir, 'kits21', 'data', scan_id, 'aggregated_MAJ_seg.nii.gz')
        ...
        lesion_labels = (seg_labels == 2).astype(int)
        ...
        if self.crop_kidney_slices:
            ...
            ct = ct[kidney_slices]
            lesion_labels = lesion_labels[kidney_slices]
